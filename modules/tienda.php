        ...
        <div class="row justify-content-center align-items-end mb-30-none">
            <div class="col-xl-12 col-lg-12 text-center mb-30">
                <div class="banner-content" data-aos="fade-up" data-aos-duration="1800">
                    <h1 class="title">Compra tus <span>boletos</span></h1>
                </div>
            </div>
        </div>
    </div>
...
<section class="about-section about-section--style ptb-120">
    ...
    <div class="container">
        <div class="section-header text-center" data-aos="fade-up" data-aos-duration="1200">
            <h2 class="section-title">Compra tus <span>boletos</span> </h2>
        </div>
        <h3 class="text-center mb-5">¡No te quedes sin el tuyo!</h3>
        <p class="text-center mb-5">Dale click a la siguiente imagen y consigue tus boletos antes de que se acaben y disfruta de lo mejor de Mexican Fight League</p>
        <div class="row text-center align-items-center mb-30-none">
