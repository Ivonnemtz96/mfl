        ...
        <div class="row justify-content-center align-items-end mb-30-none">
            <div class="col-xl-12 col-lg-12 text-center mb-30">
                <div class="banner-content" data-aos="fade-up" data-aos-duration="1800">
                    <h1 class="title">CONTÁC<span>TANOS</span></h1>
                </div>
            </div>
        </div>
    </div>
...
<section class="contact-item-section ptb-120">
    ...
    <div class="contact-element-two my-paroller" data-paroller-factor="0.2" data-paroller-type="foreground"
        data-paroller-direction="vertical">
        ...
        <div class="row justify-content-center">
            <div class="col-xl-10 col-lg-12 text-center">
                <div class="section-header">
                    <h2 class="section-title">Si tienes alguna duda o pregunta <span>escríbenos</span></h2>
                    <!-- <p>
                        There were twelve rules in all, and they specified that fights should be "a fair stand-up boxing match" in a 24-foot-square or similar ring. Rounds were three minutes with one-minute rest.
                    </p> -->
                </div>
            </div>
        </div>
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 mb-30">
                <div class="contact-item">
                    ...
                    <div class="contact-content">
                        ...
                        <p>San José del Cabo <br> <a href="https://www.google.com/maps/@23.0902874,-109.7091726"
                                target="_blank">Ver mapa</a> </p>
                    </div>
                </div>
            </div>
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 mb-30">
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 mb-30">
                <div class="contact-item">
                    ...
                    <div class="contact-content">
                        ...
                        <p>info@mexicanfightleague.com <br> <a href="mailto:info@mexicanfightleague.com">Enviar
                                correo</a> </p>
                    </div>
                </div>
            </div>
        ...
        <div class="row justify-content-center align-items-center mb-60-none">
            <div class="col-xl-6 col-lg-6 mb-60">
                <div class="account-widget-left">
                    <div class="section-header">
                        <h2 class="section-title">¿Alguna pregunta?
            ...
            <div class="col-xl-6 col-lg-6 mb-60">
                <div class="account-widget-form-area">
                    <form class="account-widget-form">
                        <div class="row justify-content-center mb-25-none">
                            ...
                            <div class="col-xl-12 form-group">
                                <button type="submit" class="btn--base">Enviar<i
        ...
        <div class="row justify-content-center mb-5-none">
            <div class="col-xl-12">
                <div class="map-area">
                    ...
                    <iframe
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3670.1855851662244!2d-109.71016168496729!3d23.090301219587413!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x86af51532c7132c7%3A0xf09c9724da511bbd!2sBanana%20Marketing%20Group!5e0!3m2!1ses-419!2smx!4v1665783965303!5m2!1ses-419!2smx"
